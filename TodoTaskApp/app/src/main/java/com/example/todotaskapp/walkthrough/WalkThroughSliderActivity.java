package com.example.todotaskapp.walkthrough;
...
//        R.layout.walk_through_slide3_layout,
    ...
    void goToMainActivity (){
        SharedPreferenceUtils.getInstance(WalkThroughSliderActivity.this).setValue(Constants.isFirstTime, true);
        startActivity(new Intent (WalkThroughSliderActivity.this,MainActivity.class));
    }
